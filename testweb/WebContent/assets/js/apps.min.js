...
var handleResetLocalStorage = function() {
    ...
    function(e) {
        e.preventDefault();
        var t = "" + '<div class="modal fade" data-modal-id="reset-local-storage-confirmation">' + '    <div class="modal-dialog">' + '        <div class="modal-content">' + '            <div class="modal-header">' + '                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>' + '                <h4 class="modal-title"><i class="fa fa-refresh m-r-5"></i> 閲嶇疆鏈湴閰嶇疆瀛樺偍</h4>' + "            </div>" + '            <div class="modal-body">' + '                <div class="alert alert-info m-b-0">Would you like to RESET all your saved widgets and clear Local Storage?</div>' + "            </div>" + '            <div class="modal-footer">' + '                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal"><i class="fa fa-close"></i> 鍚�/a>' + '                <a href="javascript:;" class="btn btn-sm btn-inverse" data-click="confirm-reset-local-storage"><i class="fa fa-check"></i> 鏄�/a>' + "            </div>" + "        </div>" + "    </div>" + "</div>";
        $("body").append(t);
...
var default_content = '<div class="p-t-40 p-b-40 text-center f-s-20 content"><i class="fa fa-warning fa-lg text-muted m-r-5"></i> <span class="f-w-600 text-inverse">Error 404! 椤甸潰鏈壘鍒�</span></div>';
...
var fillSelect = function() {
    "use strict";
    var ddlYear1 = document.getElementById("yyyy1");
    var ddlMonth1 = document.getElementById("mm1");
    var ddlDate1 = document.getElementById("dd1");
    var ddlYear2 = document.getElementById("yyyy2");
    var ddlMonth2 = document.getElementById("mm2");
    var ddlDate2 = document.getElementById("dd2");
    var opt1 = null;
    var opt2 = null;
     var curDay = new Date();
 ...
 for (var i = 2000; i < year+1; i++) 
 {
     ...
     opt2.value = i;
     opt2.innerText = i;
     ddlYear1.appendChild(opt1);
     ddlYear2.appendChild(opt2);
 }
 ddlYear1.value = curDay.getFullYear();
 ddlYear2.value = curDay.getFullYear();
 for (var i = 1; i <= 12; i++) 
 {
     opt1 = document.createElement("OPTION");
     opt1.value = i;
     ...
     opt2.value = i;
     opt2.innerText = i;
     ddlMonth1.appendChild(opt1);
     ddlMonth2.appendChild(opt2);
 }
 ddlMonth1.value = curDay.getMonth() + 1;
 ddlMonth2.value = curDay.getMonth() + 1;
 for (var i = 1; i <= 30; i++) 
 {
     opt1 = document.createElement("OPTION");
     opt1.value = i;
     ...
     opt2.value = i;
     opt2.innerText = i;
     ddlDate1.appendChild(opt1);
     ddlDate2.appendChild(opt2);
 }
 ddlDate1.value = curDay.getDate();
 ddlDate2.value = curDay.getDate();
};
var App = function() {
    "use strict";
    return {
